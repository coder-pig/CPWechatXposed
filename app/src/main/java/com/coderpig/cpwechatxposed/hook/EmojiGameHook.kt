...
object EmojiGameHook {
    fun hook(lpparam: XC_LoadPackage.LoadPackageParam) {
        val clazz = XposedHelpers.findClass("com.tencent.mm.sdk.platformtools.bk", lpparam.classLoader)
        XposedHelpers.findAndHookMethod(clazz, "fe", Int::class.java, Int::class.java, object : XC_MethodHook() {
